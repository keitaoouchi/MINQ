...
final class ItemDetailViewController: UIViewController {
  ...
  private var tagsController: TagsCollectionViewController!
...
private extension ItemDetailViewController {
  ...
  func layout() {
    ...
    tagsController = TagsCollectionViewController(item: item)
    addChild(tagsController!)

    let headerView = ItemDetailHeaderView(item: item)
    headerView.translatesAutoresizingMaskIntoConstraints = false
    tagsController.view.translatesAutoresizingMaskIntoConstraints = false
    markdownView.translatesAutoresizingMaskIntoConstraints = false

    contentView.addSubview(headerView)
    contentView.addSubview(tagsController.view)
    ...
    NSLayoutConstraint.activate([
      ...
      tagsController.view.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 0),
      tagsController.view.leadingAnchor.constraint(equalTo: headerView.leadingAnchor),
      tagsController.view.trailingAnchor.constraint(equalTo: headerView.trailingAnchor),
      markdownView.topAnchor.constraint(equalTo: tagsController.view.bottomAnchor, constant: 16),
    ...
    tagsController.didMove(toParent: self)
...
extension ItemDetailViewController {
  ...
  func configureMarkdown() {
    ...
    markdownView.load(markdown: item.body, css: Markdown.CSS.markdown, plugins: Markdown.JS.plugins, styled: false)
  }
  ...
  func showSorryView() {
    ...
    NSLayoutConstraint.activate([
      sorryView.topAnchor.constraint(equalTo: tagsController.view.bottomAnchor, constant: 0),
